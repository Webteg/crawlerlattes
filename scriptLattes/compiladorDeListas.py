...
#
#  Este programa Ã© distribuÃ­do na esperanÃ§a que possa ser util,
...
class CompiladorDeListas:
    ...
    # Para projetos nÃ£o Ã© feita a busca de projetos similares (NÃƒO MAIS UTILIZADA)
    ...
    # combinacoes 2 a 2 de todos os co-autores da publicaÃ§Ã£o
    # exemplo:
    # lista = [0, 3, 1]
    ...
    def imprimirListasCompletas(self):
        print "\n\n[LISTA COMPILADA DE PRODUÃ‡Ã•ES]"
        ...
        print "\n\n[LISTA COMPILADA DE ORIENTAÃ‡Ã•ES]"
        print "\nOA - Pos doutorado"
